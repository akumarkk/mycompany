...
enum opt_code
{
  ...
  OPT_Wall = 158,                            /* -Wall */
  OPT_Wall_deprecation = 159,                /* -Wall-deprecation */
  OPT_Wall_javadoc = 160,                    /* -Wall-javadoc */
  OPT_Wampersand = 161,                      /* -Wampersand */
  OPT_Warray_bounds = 162,                   /* -Warray-bounds */
  OPT_Warray_temporaries = 163,              /* -Warray-temporaries */
  OPT_Wassert_identifier = 164,              /* -Wassert-identifier */
  OPT_Wassign_intercept = 165,               /* -Wassign-intercept */
  OPT_Wattributes = 166,                     /* -Wattributes */
  OPT_Wbad_function_cast = 167,              /* -Wbad-function-cast */
  OPT_Wboxing = 168,                         /* -Wboxing */
  OPT_Wbuiltin_macro_redefined = 169,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 170,                     /* -Wc++-compat */
  OPT_Wc__0x_compat = 171,                   /* -Wc++0x-compat */
  OPT_Wcast_align = 172,                     /* -Wcast-align */
  OPT_Wcast_qual = 173,                      /* -Wcast-qual */
  OPT_Wchar_concat = 174,                    /* -Wchar-concat */
  OPT_Wchar_subscripts = 175,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 176,           /* -Wcharacter-truncation */
  OPT_Wclobbered = 177,                      /* -Wclobbered */
  OPT_Wcomment = 178,                        /* -Wcomment */
  /* OPT_Wcomments = 179, */                 /* -Wcomments */
  OPT_Wcondition_assign = 180,               /* -Wcondition-assign */
  OPT_Wconstructor_name = 181,               /* -Wconstructor-name */
  OPT_Wconversion = 182,                     /* -Wconversion */
  OPT_Wconversion_extra = 183,               /* -Wconversion-extra */
  OPT_Wconversion_null = 184,                /* -Wconversion-null */
  OPT_Wcoverage_mismatch = 185,              /* -Wcoverage-mismatch */
  OPT_Wcpp = 186,                            /* -Wcpp */
  OPT_Wctor_dtor_privacy = 187,              /* -Wctor-dtor-privacy */
  OPT_Wdeclaration_after_statement = 188,    /* -Wdeclaration-after-statement */
  OPT_Wdep_ann = 189,                        /* -Wdep-ann */
  OPT_Wdeprecated = 190,                     /* -Wdeprecated */
  OPT_Wdeprecated_declarations = 191,        /* -Wdeprecated-declarations */
  OPT_Wdisabled_optimization = 192,          /* -Wdisabled-optimization */
  OPT_Wdiscouraged = 193,                    /* -Wdiscouraged */
  OPT_Wdiv_by_zero = 194,                    /* -Wdiv-by-zero */
  OPT_Wdouble_promotion = 195,               /* -Wdouble-promotion */
  OPT_Weffc__ = 196,                         /* -Weffc++ */
  OPT_Wempty_block = 197,                    /* -Wempty-block */
  OPT_Wempty_body = 198,                     /* -Wempty-body */
  OPT_Wendif_labels = 199,                   /* -Wendif-labels */
  OPT_Wenum_compare = 200,                   /* -Wenum-compare */
  OPT_Wenum_identifier = 201,                /* -Wenum-identifier */
  OPT_Wenum_switch = 202,                    /* -Wenum-switch */
  OPT_Werror = 203,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 204, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 205,                         /* -Werror= */
  OPT_Wextra = 206,                          /* -Wextra */
  OPT_Wextraneous_semicolon = 207,           /* -Wextraneous-semicolon */
  OPT_Wfallthrough = 208,                    /* -Wfallthrough */
  OPT_Wfatal_errors = 209,                   /* -Wfatal-errors */
  OPT_Wfield_hiding = 210,                   /* -Wfield-hiding */
  OPT_Wfinal_bound = 211,                    /* -Wfinal-bound */
  OPT_Wfinally = 212,                        /* -Wfinally */
  OPT_Wfloat_equal = 213,                    /* -Wfloat-equal */
  OPT_Wforbidden = 214,                      /* -Wforbidden */
  OPT_Wformat = 215,                         /* -Wformat */
  OPT_Wformat_contains_nul = 216,            /* -Wformat-contains-nul */
  OPT_Wformat_extra_args = 217,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 218,              /* -Wformat-nonliteral */
  OPT_Wformat_security = 219,                /* -Wformat-security */
  OPT_Wformat_y2k = 220,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 221,             /* -Wformat-zero-length */
  OPT_Wformat_ = 222,                        /* -Wformat= */
  OPT_Wframe_larger_than_ = 223,             /* -Wframe-larger-than= */
  OPT_Whiding = 224,                         /* -Whiding */
  OPT_Wignored_qualifiers = 225,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 226,                       /* -Wimplicit */
  OPT_Wimplicit_function_declaration = 227,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 228,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 229,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 230,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 231, */                   /* -Wimport */
  OPT_Windirect_static = 232,                /* -Windirect-static */
  OPT_Winit_self = 233,                      /* -Winit-self */
  OPT_Winline = 234,                         /* -Winline */
  OPT_Wint_to_pointer_cast = 235,            /* -Wint-to-pointer-cast */
  OPT_Wintf_annotation = 236,                /* -Wintf-annotation */
  OPT_Wintf_non_inherited = 237,             /* -Wintf-non-inherited */
  OPT_Wintrinsic_shadow = 238,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 239,                 /* -Wintrinsics-std */
  OPT_Winvalid_offsetof = 240,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 241,                    /* -Winvalid-pch */
  OPT_Wjavadoc = 242,                        /* -Wjavadoc */
  OPT_Wjump_misses_init = 243,               /* -Wjump-misses-init */
  OPT_Wl_ = 244,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 245, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 246,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 247,                /* -Wline-truncation */
  OPT_Wlocal_hiding = 248,                   /* -Wlocal-hiding */
  OPT_Wlogical_op = 249,                     /* -Wlogical-op */
  OPT_Wlong_long = 250,                      /* -Wlong-long */
  OPT_Wmain = 251,                           /* -Wmain */
  OPT_Wmasked_catch_block = 252,             /* -Wmasked-catch-block */
  OPT_Wmissing_braces = 253,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 254,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 255,     /* -Wmissing-field-initializers */
  OPT_Wmissing_format_attribute = 256,       /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 257,           /* -Wmissing-include-dirs */
  OPT_Wmissing_noreturn = 258,               /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 259,         /* -Wmissing-parameter-type */
  OPT_Wmissing_prototypes = 260,             /* -Wmissing-prototypes */
  OPT_Wmudflap = 261,                        /* -Wmudflap */
  OPT_Wmultichar = 262,                      /* -Wmultichar */
  OPT_Wnested_externs = 263,                 /* -Wnested-externs */
  OPT_Wnls = 264,                            /* -Wnls */
  OPT_Wno_effect_assign = 265,               /* -Wno-effect-assign */
  OPT_Wnoexcept = 266,                       /* -Wnoexcept */
  OPT_Wnon_template_friend = 267,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 268,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 269,                        /* -Wnonnull */
  OPT_Wnormalized_ = 270,                    /* -Wnormalized= */
  OPT_Wnull = 271,                           /* -Wnull */
  OPT_Wold_style_cast = 272,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 273,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 274,           /* -Wold-style-definition */
  OPT_Wout_of_date = 275,                    /* -Wout-of-date */
  OPT_Wover_ann = 276,                       /* -Wover-ann */
  OPT_Woverflow = 277,                       /* -Woverflow */
  OPT_Woverlength_strings = 278,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 279,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 280,                  /* -Woverride-init */
  OPT_Wp_ = 281,                             /* -Wp, */
  OPT_Wpacked = 282,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 283,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 284,                         /* -Wpadded */
  OPT_Wparam_assign = 285,                   /* -Wparam-assign */
  OPT_Wparentheses = 286,                    /* -Wparentheses */
  OPT_Wpkg_default_method = 287,             /* -Wpkg-default-method */
  OPT_Wpmf_conversions = 288,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 289,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 290,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 291,            /* -Wpointer-to-int-cast */
  OPT_Wpragmas = 292,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 293,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 294,                       /* -Wprotocol */
  OPT_Wpsabi = 295,                          /* -Wpsabi */
  OPT_Wraw = 296,                            /* -Wraw */
  OPT_Wredundant_decls = 297,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 298,            /* -Wredundant-modifiers */
  OPT_Wreorder = 299,                        /* -Wreorder */
  OPT_Wreturn_type = 300,                    /* -Wreturn-type */
  OPT_Wselector = 301,                       /* -Wselector */
  OPT_Wsequence_point = 302,                 /* -Wsequence-point */
  OPT_Wserial = 303,                         /* -Wserial */
  OPT_Wshadow = 304,                         /* -Wshadow */
  OPT_Wsign_compare = 305,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 306,                /* -Wsign-conversion */
  OPT_Wsign_promo = 307,                     /* -Wsign-promo */
  OPT_Wspecial_param_hiding = 308,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 309,                /* -Wstack-protector */
  OPT_Wstatic_access = 310,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 311,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 312,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 313,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 314,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 315,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 316,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 317,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 318,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 319,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_noreturn = 320,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 321,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 322,                       /* -Wsuppress */
  OPT_Wsurprising = 323,                     /* -Wsurprising */
  OPT_Wswitch = 324,                         /* -Wswitch */
  OPT_Wswitch_default = 325,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 326,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 327,                      /* -Wsync-nand */
  OPT_Wsynth = 328,                          /* -Wsynth */
  OPT_Wsynthetic_access = 329,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 330,                 /* -Wsystem-headers */
  OPT_Wtabs = 331,                           /* -Wtabs */
  OPT_Wtasks = 332,                          /* -Wtasks */
  OPT_Wtraditional = 333,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 334,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 335,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 336,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 337,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 338,                    /* -Wtype-limits */
  OPT_Wuncheck = 339,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 340,            /* -Wundeclared-selector */
  OPT_Wundef = 341,                          /* -Wundef */
  OPT_Wunderflow = 342,                      /* -Wunderflow */
  OPT_Wuninitialized = 343,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 344,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 345,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 346,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 347, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 348,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 349,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 350,                         /* -Wunused */
  OPT_Wunused_argument = 351,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 352,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 353,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 354,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 355,                /* -Wunused-function */
  OPT_Wunused_import = 356,                  /* -Wunused-import */
  OPT_Wunused_label = 357,                   /* -Wunused-label */
  OPT_Wunused_local = 358,                   /* -Wunused-local */
  OPT_Wunused_macros = 359,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 360,               /* -Wunused-parameter */
  OPT_Wunused_private = 361,                 /* -Wunused-private */
  OPT_Wunused_result = 362,                  /* -Wunused-result */
  OPT_Wunused_thrown = 363,                  /* -Wunused-thrown */
  OPT_Wunused_value = 364,                   /* -Wunused-value */
  OPT_Wunused_variable = 365,                /* -Wunused-variable */
  OPT_Wuseless_type_check = 366,             /* -Wuseless-type-check */
  OPT_Wvarargs_cast = 367,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 368,                /* -Wvariadic-macros */
  OPT_Wvla = 369,                            /* -Wvla */
  OPT_Wvolatile_register_var = 370,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 371,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 372,                  /* -Wwrite-strings */
  OPT_Xassembler = 373,                      /* -Xassembler */
  OPT_Xlinker = 374,                         /* -Xlinker */
  OPT_Xpreprocessor = 375,                   /* -Xpreprocessor */
  OPT_Z = 376,                               /* -Z */
  OPT_ansi = 377,                            /* -ansi */
  OPT_aux_info = 378,                        /* -aux-info */
  /* OPT_aux_info_ = 379, */                 /* -aux-info= */
  OPT_auxbase = 380,                         /* -auxbase */
  OPT_auxbase_strip = 381,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 382, */             /* -bootclasspath */
  OPT_c = 383,                               /* -c */
  /* OPT_classpath = 384, */                 /* -classpath */
  OPT_coverage = 385,                        /* -coverage */
  OPT_cpp = 386,                             /* -cpp */
  OPT_cpp_ = 387,                            /* -cpp= */
  OPT_d = 388,                               /* -d */
  ...
  OPT_e = 394,                               /* -e */
  /* OPT_encoding = 395, */                  /* -encoding */
  OPT_export_dynamic = 396,                  /* -export-dynamic */
  OPT_extdirs = 397,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 398, */               /* -fCLASSPATH= */
  OPT_fPIC = 399,                            /* -fPIC */
  OPT_fPIE = 400,                            /* -fPIE */
  OPT_fRTS_ = 401,                           /* -fRTS= */
  OPT_fabi_version_ = 402,                   /* -fabi-version= */
  OPT_faccess_control = 403,                 /* -faccess-control */
  OPT_falign_commons = 404,                  /* -falign-commons */
  OPT_falign_functions = 405,                /* -falign-functions */
  OPT_falign_functions_ = 406,               /* -falign-functions= */
  OPT_falign_jumps = 407,                    /* -falign-jumps */
  OPT_falign_jumps_ = 408,                   /* -falign-jumps= */
  OPT_falign_labels = 409,                   /* -falign-labels */
  OPT_falign_labels_ = 410,                  /* -falign-labels= */
  OPT_falign_loops = 411,                    /* -falign-loops */
  OPT_falign_loops_ = 412,                   /* -falign-loops= */
  OPT_fall_intrinsics = 413,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 414, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 415,       /* -fallow-leading-underscore */
  /* OPT_falt_external_templates = 416, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 417, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 418, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 419, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 420, */  /* -fargument-noalias-global */
  OPT_fasm = 421,                            /* -fasm */
  OPT_fassert = 422,                         /* -fassert */
  OPT_fassociative_math = 423,               /* -fassociative-math */
  OPT_fassume_compiled = 424,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 425,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 426,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 427,                   /* -fauto-inc-dec */
  OPT_fautomatic = 428,                      /* -fautomatic */
  OPT_faux_classpath = 429,                  /* -faux-classpath */
  OPT_fbackslash = 430,                      /* -fbackslash */
  OPT_fbacktrace = 431,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 432,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 433,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 434,              /* -fbootstrap-classes */
  OPT_fbounds_check = 435,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 436,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 437,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 438,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 439,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 440,               /* -fbtr-bb-exclusive */
  OPT_fbuiltin = 441,                        /* -fbuiltin */
  OPT_fbuiltin_ = 442,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 443,                    /* -fcall-saved- */
  OPT_fcall_used_ = 444,                     /* -fcall-used- */
  OPT_fcaller_saves = 445,                   /* -fcaller-saves */
  OPT_fcheck_array_temporaries = 446,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 447,                /* -fcheck-data-deps */
  OPT_fcheck_new = 448,                      /* -fcheck-new */
  OPT_fcheck_references = 449,               /* -fcheck-references */
  OPT_fcheck_ = 450,                         /* -fcheck= */
  OPT_fclasspath_ = 451,                     /* -fclasspath= */
  OPT_fcoarray_ = 452,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 453,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 454,                         /* -fcommon */
  OPT_fcompare_debug = 455,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 456,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 457,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 458,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 459,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 460,                  /* -fcond-mismatch */
  OPT_fconserve_space = 461,                 /* -fconserve-space */
  OPT_fconserve_stack = 462,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 463,         /* -fconstant-string-class= */
  OPT_fconvert_big_endian = 464,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 465,          /* -fconvert=little-endian */
  OPT_fconvert_native = 466,                 /* -fconvert=native */
  OPT_fconvert_swap = 467,                   /* -fconvert=swap */
  OPT_fcprop_registers = 468,                /* -fcprop-registers */
  OPT_fcray_pointer = 469,                   /* -fcray-pointer */
  OPT_fcrossjumping = 470,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 471,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 472, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 473,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 474,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 475,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 476,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 477,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 478,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 479,                       /* -fdbg-cnt= */
  OPT_fdce = 480,                            /* -fdce */
  OPT_fdebug_prefix_map_ = 481,              /* -fdebug-prefix-map= */
  OPT_fdeduce_init_list = 482,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 483,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 484, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 485,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 486,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 487,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 488,                 /* -fdelayed-branch */
  OPT_fdelete_null_pointer_checks = 489,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 490,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_location_ = 491,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 492,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 493,                /* -fdirectives-only */
  OPT_fdisable_assertions = 494,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 495,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 496,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 497,         /* -fdollars-in-identifiers */
  OPT_fdse = 498,                            /* -fdse */
  OPT_fdump_ = 499,                          /* -fdump- */
  OPT_fdump_core = 500,                      /* -fdump-core */
  OPT_fdump_final_insns = 501,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 502,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 503,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 504,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 505,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 506,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 507,                /* -fdump-parse-tree */
  OPT_fdump_unnumbered = 508,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 509,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 510,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 511,                 /* -fearly-inlining */
  OPT_felide_constructors = 512,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 513,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 514, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 515,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 516,        /* -femit-class-debug-always */
  OPT_femit_class_file = 517,                /* -femit-class-file */
  OPT_femit_class_files = 518,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 519,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 520,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 521,      /* -femit-struct-debug-reduced */
  OPT_fenable_assertions = 522,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 523,             /* -fenable-assertions= */
  OPT_fenable_icf_debug = 524,               /* -fenable-icf-debug */
  OPT_fencoding_ = 525,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 526,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 527, */           /* -fenum-int-equiv */
  OPT_fexceptions = 528,                     /* -fexceptions */
  OPT_fexcess_precision_ = 529,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 530,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 531,        /* -fexpensive-optimizations */
  OPT_fextdirs_ = 532,                       /* -fextdirs= */
  OPT_fextended_identifiers = 533,           /* -fextended-identifiers */
  OPT_fexternal_blas = 534,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 535, */       /* -fexternal-templates */
  OPT_ff2c = 536,                            /* -ff2c */
  OPT_ffast_math = 537,                      /* -ffast-math */
  OPT_ffilelist_file = 538,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 539,               /* -ffinite-math-only */
  OPT_ffixed_ = 540,                         /* -ffixed- */
  OPT_ffixed_form = 541,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 542,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 543,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 544,                    /* -ffloat-store */
  OPT_ffor_scope = 545,                      /* -ffor-scope */
  /* OPT_fforce_addr = 546, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 547,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 548,              /* -fforward-propagate */
  OPT_ffp_contract_ = 549,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 550,                      /* -ffpe-trap= */
  OPT_ffree_form = 551,                      /* -ffree-form */
  OPT_ffree_line_length_ = 552,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 553,          /* -ffree-line-length-none */
  OPT_ffreestanding = 554,                   /* -ffreestanding */
  OPT_ffriend_injection = 555,               /* -ffriend-injection */
  OPT_ffunction_cse = 556,                   /* -ffunction-cse */
  OPT_ffunction_sections = 557,              /* -ffunction-sections */
  OPT_fgcse = 558,                           /* -fgcse */
  OPT_fgcse_after_reload = 559,              /* -fgcse-after-reload */
  OPT_fgcse_las = 560,                       /* -fgcse-las */
  OPT_fgcse_lm = 561,                        /* -fgcse-lm */
  OPT_fgcse_sm = 562,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 563,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 564,                    /* -fgnu-runtime */
  OPT_fgnu89_inline = 565,                   /* -fgnu89-inline */
  OPT_fgo_dump_ = 566,                       /* -fgo-dump- */
  OPT_fgo_prefix_ = 567,                     /* -fgo-prefix= */
  OPT_fgraphite = 568,                       /* -fgraphite */
  OPT_fgraphite_identity = 569,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 570,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 571, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 572, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 573,           /* -fhash-synchronization */
  /* OPT_fhelp = 574, */                     /* -fhelp */
  /* OPT_fhelp_ = 575, */                    /* -fhelp= */
  /* OPT_fhonor_std = 576, */                /* -fhonor-std */
  OPT_fhosted = 577,                         /* -fhosted */
  /* OPT_fhuge_objects = 578, */             /* -fhuge-objects */
  OPT_fident = 579,                          /* -fident */
  OPT_fif_conversion = 580,                  /* -fif-conversion */
  OPT_fif_conversion2 = 581,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 582,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 583,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 584,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 585,             /* -fimplicit-templates */
  OPT_findirect_classes = 586,               /* -findirect-classes */
  OPT_findirect_dispatch = 587,              /* -findirect-dispatch */
  OPT_findirect_inlining = 588,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 589,         /* -finhibit-size-directive */
  OPT_finit_character_ = 590,                /* -finit-character= */
  OPT_finit_integer_ = 591,                  /* -finit-integer= */
  OPT_finit_local_zero = 592,                /* -finit-local-zero */
  OPT_finit_logical_ = 593,                  /* -finit-logical= */
  OPT_finit_real_ = 594,                     /* -finit-real= */
  OPT_finline = 595,                         /* -finline */
  OPT_finline_functions = 596,               /* -finline-functions */
  OPT_finline_functions_called_once = 597,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 598, */            /* -finline-limit- */
  OPT_finline_limit_ = 599,                  /* -finline-limit= */
  OPT_finline_small_functions = 600,         /* -finline-small-functions */
  OPT_finput_charset_ = 601,                 /* -finput-charset= */
  OPT_finstrument_functions = 602,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 603,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 604,/* -finstrument-functions-exclude-function-list= */
  OPT_fintrinsic_modules_path = 605,         /* -fintrinsic-modules-path */
  OPT_fipa_cp = 606,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 607,                   /* -fipa-cp-clone */
  OPT_fipa_matrix_reorg = 608,               /* -fipa-matrix-reorg */
  OPT_fipa_profile = 609,                    /* -fipa-profile */
  OPT_fipa_pta = 610,                        /* -fipa-pta */
  OPT_fipa_pure_const = 611,                 /* -fipa-pure-const */
  OPT_fipa_reference = 612,                  /* -fipa-reference */
  OPT_fipa_sra = 613,                        /* -fipa-sra */
  OPT_fipa_struct_reorg = 614,               /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 615,                 /* -fira-algorithm= */
  OPT_fira_loop_pressure = 616,              /* -fira-loop-pressure */
  OPT_fira_region_ = 617,                    /* -fira-region= */
  OPT_fira_share_save_slots = 618,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 619,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 620,                   /* -fira-verbose= */
  OPT_fivopts = 621,                         /* -fivopts */
  OPT_fjni = 622,                            /* -fjni */
  OPT_fjump_tables = 623,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 624,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 625,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 626,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 627, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 628,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 629,             /* -fleading-underscore */
  OPT_floop_block = 630,                     /* -floop-block */
  OPT_floop_flatten = 631,                   /* -floop-flatten */
  OPT_floop_interchange = 632,               /* -floop-interchange */
  /* OPT_floop_optimize = 633, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 634,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 635,                /* -floop-strip-mine */
  OPT_flto = 636,                            /* -flto */
  OPT_flto_compression_level_ = 637,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 638,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 639,         /* -flto-partition=balanced */
  OPT_flto_partition_none = 640,             /* -flto-partition=none */
  OPT_flto_report = 641,                     /* -flto-report */
  OPT_flto_ = 642,                           /* -flto= */
  OPT_fltrans = 643,                         /* -fltrans */
  OPT_fltrans_output_list_ = 644,            /* -fltrans-output-list= */
  OPT_fmain_ = 645,                          /* -fmain= */
  OPT_fmath_errno = 646,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 647,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 648,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 649,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 650,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 651,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 652,                     /* -fmem-report */
  OPT_fmerge_all_constants = 653,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 654,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 655,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 656,                /* -fmessage-length= */
  OPT_fmodule_private = 657,                 /* -fmodule-private */
  OPT_fmodulo_sched = 658,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 659,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 660,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 661,                  /* -fms-extensions */
  OPT_fmudflap = 662,                        /* -fmudflap */
  OPT_fmudflapir = 663,                      /* -fmudflapir */
  OPT_fmudflapth = 664,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 665, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 666, */                  /* -fnew-abi */
  OPT_fnext_runtime = 667,                   /* -fnext-runtime */
  OPT_fnil_receivers = 668,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 669,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 670,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 671, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 672,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 673,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 674,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 675,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 676,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 677,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 678,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 679,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 680,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 681,             /* -fomit-frame-pointer */
  OPT_fopenmp = 682,                         /* -fopenmp */
  OPT_foperator_names = 683,                 /* -foperator-names */
  OPT_foptimize_register_move = 684,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 685,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 686,/* -foptimize-static-class-initialization */
  /* OPT_foptional_diags = 687, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 688,              /* -foutput-class-dir= */
  OPT_fpack_derived = 689,                   /* -fpack-derived */
  OPT_fpack_struct = 690,                    /* -fpack-struct */
  OPT_fpack_struct_ = 691,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 692,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 693,              /* -fpcc-struct-return */
  OPT_fpch_deps = 694,                       /* -fpch-deps */
  OPT_fpch_preprocess = 695,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 696,                     /* -fpeel-loops */
  OPT_fpeephole = 697,                       /* -fpeephole */
  OPT_fpeephole2 = 698,                      /* -fpeephole2 */
  OPT_fpermissive = 699,                     /* -fpermissive */
  OPT_fpic = 700,                            /* -fpic */
  OPT_fpie = 701,                            /* -fpie */
  OPT_fplan9_extensions = 702,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 703,                    /* -fplugin-arg- */
  OPT_fplugin_ = 704,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 705,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 706,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 707,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 708,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 709,                   /* -fpreprocessed */
  OPT_fpretty_templates = 710,               /* -fpretty-templates */
  OPT_fprofile = 711,                        /* -fprofile */
  OPT_fprofile_arcs = 712,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 713,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 714,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 715,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 716,              /* -fprofile-generate= */
  OPT_fprofile_use = 717,                    /* -fprofile-use */
  OPT_fprofile_use_ = 718,                   /* -fprofile-use= */
  OPT_fprofile_values = 719,                 /* -fprofile-values */
  OPT_fprotect_parens = 720,                 /* -fprotect-parens */
  OPT_frandom_seed = 721,                    /* -frandom-seed */
  OPT_frandom_seed_ = 722,                   /* -frandom-seed= */
  OPT_frange_check = 723,                    /* -frange-check */
  OPT_frealloc_lhs = 724,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 725,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 726,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 727,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 728,                /* -frecord-marker=8 */
  OPT_frecursive = 729,                      /* -frecursive */
  OPT_freduced_reflection = 730,             /* -freduced-reflection */
  OPT_freg_struct_return = 731,              /* -freg-struct-return */
  OPT_fregmove = 732,                        /* -fregmove */
  OPT_frename_registers = 733,               /* -frename-registers */
  OPT_freorder_blocks = 734,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 735,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 736,              /* -freorder-functions */
  OPT_frepack_arrays = 737,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 738,           /* -freplace-objc-classes */
  OPT_frepo = 739,                           /* -frepo */
  OPT_frequire_return_statement = 740,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 741,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 742, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 743,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 744,                    /* -fresolution= */
  OPT_frounding_math = 745,                  /* -frounding-math */
  OPT_frtti = 746,                           /* -frtti */
  OPT_fsaw_java_file = 747,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 748,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 749,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 750,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 751,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 752,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 753,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 754,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 755,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 756,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 757,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 758,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 759,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 760,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 761,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 762,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 763,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 764,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 765, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 766,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 767,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 768,              /* -fsecond-underscore */
  OPT_fsection_anchors = 769,                /* -fsection-anchors */
  /* OPT_fsee = 770, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 771,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 772,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 773, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 774,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 775,          /* -fselective-scheduling2 */
  OPT_fshort_double = 776,                   /* -fshort-double */
  OPT_fshort_enums = 777,                    /* -fshort-enums */
  OPT_fshort_wchar = 778,                    /* -fshort-wchar */
  OPT_fshow_column = 779,                    /* -fshow-column */
  OPT_fsign_zero = 780,                      /* -fsign-zero */
  OPT_fsignaling_nans = 781,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 782,               /* -fsigned-bitfields */
  OPT_fsigned_char = 783,                    /* -fsigned-char */
  OPT_fsigned_zeros = 784,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 785,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 786,               /* -fsource-filename= */
  OPT_fsource_ = 787,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 788,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 789,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 790,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 791, */                 /* -fsquangle */
  /* OPT_fstack_check = 792, */              /* -fstack-check */
  OPT_fstack_check_ = 793,                   /* -fstack-check= */
  OPT_fstack_limit = 794,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 795,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 796,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 797,                /* -fstack-protector */
  OPT_fstack_protector_all = 798,            /* -fstack-protector-all */
  OPT_fstack_usage = 799,                    /* -fstack-usage */
  OPT_fstats = 800,                          /* -fstats */
  OPT_fstore_check = 801,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 802, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 803,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 804,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 805,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 806, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 807,      /* -fstrict-volatile-bitfields */
  OPT_fsyntax_only = 808,                    /* -fsyntax-only */
  OPT_ftabstop_ = 809,                       /* -ftabstop= */
  /* OPT_ftarget_help = 810, */              /* -ftarget-help */
  OPT_ftarget_ = 811,                        /* -ftarget= */
  /* OPT_ftemplate_depth_ = 812, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 813,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 814,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 815, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 816,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 817,             /* -fthreadsafe-statics */
  OPT_ftime_report = 818,                    /* -ftime-report */
  OPT_ftls_model_ = 819,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 820,               /* -ftoplevel-reorder */
  OPT_ftracer = 821,                         /* -ftracer */
  OPT_ftrapping_math = 822,                  /* -ftrapping-math */
  OPT_ftrapv = 823,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 824,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 825,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 826,                       /* -ftree-ccp */
  OPT_ftree_ch = 827,                        /* -ftree-ch */
  ...
  OPT_ftree_lrs = 844,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 845,        /* -ftree-parallelize-loops= */
  OPT_ftree_phiprop = 846,                   /* -ftree-phiprop */
  OPT_ftree_pre = 847,                       /* -ftree-pre */
  OPT_ftree_pta = 848,                       /* -ftree-pta */
  OPT_ftree_reassoc = 849,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 850, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 851,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 852,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 853,             /* -ftree-slp-vectorize */
  OPT_ftree_sra = 854,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 855, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 856, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 857,         /* -ftree-switch-conversion */
  OPT_ftree_ter = 858,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 859,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 860,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 861,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 862,                       /* -ftree-vrp */
  OPT_funderscoring = 863,                   /* -funderscoring */
  OPT_funit_at_a_time = 864,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 865,               /* -funroll-all-loops */
  OPT_funroll_loops = 866,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 867,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 868,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 869,             /* -funsigned-bitfields */
  OPT_funsigned_char = 870,                  /* -funsigned-char */
  OPT_funswitch_loops = 871,                 /* -funswitch-loops */
  OPT_funwind_tables = 872,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 873,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 874,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 875,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 876,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 877,          /* -fuse-divide-subroutine */
  OPT_fuse_linker_plugin = 878,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 879,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 880,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 881,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 882,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 883, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 884,                /* -fvect-cost-model */
  OPT_fverbose_asm = 885,                    /* -fverbose-asm */
  /* OPT_fversion = 886, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 887,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 888,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 889,                    /* -fvisibility= */
  OPT_fvpt = 890,                            /* -fvpt */
  /* OPT_fvtable_gc = 891, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 892, */            /* -fvtable-thunks */
  OPT_fweak = 893,                           /* -fweak */
  OPT_fweb = 894,                            /* -fweb */
  OPT_fwhole_file = 895,                     /* -fwhole-file */
  OPT_fwhole_program = 896,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 897,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 898,              /* -fworking-directory */
  OPT_fwpa = 899,                            /* -fwpa */
  OPT_fwrapv = 900,                          /* -fwrapv */
  /* OPT_fxref = 901, */                     /* -fxref */
  OPT_fzee = 902,                            /* -fzee */
  OPT_fzero_initialized_in_bss = 903,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 904,                      /* -fzero-link */
  OPT_g = 905,                               /* -g */
  OPT_gant = 906,                            /* -gant */
  OPT_gcoff = 907,                           /* -gcoff */
  OPT_gdwarf_ = 908,                         /* -gdwarf- */
  OPT_gen_decls = 909,                       /* -gen-decls */
  OPT_ggdb = 910,                            /* -ggdb */
  OPT_gnat = 911,                            /* -gnat */
  OPT_gnatO = 912,                           /* -gnatO */
  OPT_gno_strict_dwarf = 913,                /* -gno-strict-dwarf */
  OPT_gstabs = 914,                          /* -gstabs */
  OPT_gstabs_ = 915,                         /* -gstabs+ */
  OPT_gstrict_dwarf = 916,                   /* -gstrict-dwarf */
  OPT_gtoggle = 917,                         /* -gtoggle */
  OPT_gvms = 918,                            /* -gvms */
  OPT_gxcoff = 919,                          /* -gxcoff */
  OPT_gxcoff_ = 920,                         /* -gxcoff+ */
  OPT_h = 921,                               /* -h */
  OPT_idirafter = 922,                       /* -idirafter */
  OPT_imacros = 923,                         /* -imacros */
  OPT_imultilib = 924,                       /* -imultilib */
  OPT_include = 925,                         /* -include */
  OPT_iplugindir_ = 926,                     /* -iplugindir= */
  OPT_iprefix = 927,                         /* -iprefix */
  OPT_iquote = 928,                          /* -iquote */
  OPT_isysroot = 929,                        /* -isysroot */
  OPT_isystem = 930,                         /* -isystem */
  OPT_iwithprefix = 931,                     /* -iwithprefix */
  OPT_iwithprefixbefore = 932,               /* -iwithprefixbefore */
  OPT_k8 = 933,                              /* -k8 */
  OPT_l = 934,                               /* -l */
  OPT_lang_asm = 935,                        /* -lang-asm */
  OPT_m128bit_long_double = 936,             /* -m128bit-long-double */
  OPT_m32 = 937,                             /* -m32 */
  OPT_m3dnow = 938,                          /* -m3dnow */
  OPT_m3dnowa = 939,                         /* -m3dnowa */
  OPT_m64 = 940,                             /* -m64 */
  OPT_m80387 = 941,                          /* -m80387 */
  OPT_m8bit_idiv = 942,                      /* -m8bit-idiv */
  OPT_m96bit_long_double = 943,              /* -m96bit-long-double */
  OPT_mabi_ = 944,                           /* -mabi= */
  OPT_mabm = 945,                            /* -mabm */
  OPT_maccumulate_outgoing_args = 946,       /* -maccumulate-outgoing-args */
  OPT_maes = 947,                            /* -maes */
  OPT_malign_double = 948,                   /* -malign-double */
  OPT_malign_functions_ = 949,               /* -malign-functions= */
  OPT_malign_jumps_ = 950,                   /* -malign-jumps= */
  OPT_malign_loops_ = 951,                   /* -malign-loops= */
  OPT_malign_stringops = 952,                /* -malign-stringops */
  OPT_mandroid = 953,                        /* -mandroid */
  OPT_march_ = 954,                          /* -march= */
  OPT_masm_ = 955,                           /* -masm= */
  OPT_mavx = 956,                            /* -mavx */
  OPT_mbionic = 957,                         /* -mbionic */
  OPT_mbmi = 958,                            /* -mbmi */
  OPT_mbranch_cost_ = 959,                   /* -mbranch-cost= */
  OPT_mcld = 960,                            /* -mcld */
  OPT_mcmodel_ = 961,                        /* -mcmodel= */
  /* OPT_mcpu_ = 962, */                     /* -mcpu= */
  OPT_mcrc32 = 963,                          /* -mcrc32 */
  OPT_mcx16 = 964,                           /* -mcx16 */
  OPT_mdispatch_scheduler = 965,             /* -mdispatch-scheduler */
  OPT_mf16c = 966,                           /* -mf16c */
  OPT_mfancy_math_387 = 967,                 /* -mfancy-math-387 */
  OPT_mfentry = 968,                         /* -mfentry */
  OPT_mfma = 969,                            /* -mfma */
  OPT_mfma4 = 970,                           /* -mfma4 */
  OPT_mforce_drap = 971,                     /* -mforce-drap */
  OPT_mfp_ret_in_387 = 972,                  /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 973,                        /* -mfpmath= */
  OPT_mfsgsbase = 974,                       /* -mfsgsbase */
  /* OPT_mfused_madd = 975, */               /* -mfused-madd */
  OPT_mglibc = 976,                          /* -mglibc */
  OPT_mhard_float = 977,                     /* -mhard-float */
  OPT_mieee_fp = 978,                        /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 979,       /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 980,           /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 981,   /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 982, */             /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 983,          /* -mlarge-data-threshold= */
  OPT_mlwp = 984,                            /* -mlwp */
  OPT_mmmx = 985,                            /* -mmmx */
  OPT_mmovbe = 986,                          /* -mmovbe */
  OPT_mms_bitfields = 987,                   /* -mms-bitfields */
  OPT_mno_align_stringops = 988,             /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 989,              /* -mno-fancy-math-387 */
  OPT_mno_push_args = 990,                   /* -mno-push-args */
  OPT_mno_red_zone = 991,                    /* -mno-red-zone */
  OPT_mno_sse4 = 992,                        /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 993,        /* -momit-leaf-frame-pointer */
  OPT_mpc = 994,                             /* -mpc */
  OPT_mpclmul = 995,                         /* -mpclmul */
  OPT_mpopcnt = 996,                         /* -mpopcnt */
  OPT_mprefer_avx128 = 997,                  /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 998,      /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 999,                      /* -mpush-args */
  OPT_mrdrnd = 1000,                         /* -mrdrnd */
  OPT_mrecip = 1001,                         /* -mrecip */
  OPT_mred_zone = 1002,                      /* -mred-zone */
  OPT_mregparm_ = 1003,                      /* -mregparm= */
  OPT_mrtd = 1004,                           /* -mrtd */
  OPT_msahf = 1005,                          /* -msahf */
  OPT_msoft_float = 1006,                    /* -msoft-float */
  OPT_msse = 1007,                           /* -msse */
  OPT_msse2 = 1008,                          /* -msse2 */
  OPT_msse2avx = 1009,                       /* -msse2avx */
  OPT_msse3 = 1010,                          /* -msse3 */
  OPT_msse4 = 1011,                          /* -msse4 */
  OPT_msse4_1 = 1012,                        /* -msse4.1 */
  OPT_msse4_2 = 1013,                        /* -msse4.2 */
  OPT_msse4a = 1014,                         /* -msse4a */
  /* OPT_msse5 = 1015, */                    /* -msse5 */
  OPT_msseregparm = 1016,                    /* -msseregparm */
  OPT_mssse3 = 1017,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1018,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1019,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1020,            /* -mstringop-strategy= */
  OPT_mtbm = 1021,                           /* -mtbm */
  OPT_mtls_dialect_ = 1022,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1023,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1024,                         /* -mtune= */
  OPT_muclibc = 1025,                        /* -muclibc */
  OPT_mveclibabi_ = 1026,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1027,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1028,                    /* -mvzeroupper */
  OPT_mxop = 1029,                           /* -mxop */
  OPT_n = 1030,                              /* -n */
  ...
  OPT_std_c1x = 1080,                        /* -std=c1x */
  /* OPT_std_c89 = 1081, */                  /* -std=c89 */
  OPT_std_c90 = 1082,                        /* -std=c90 */
  OPT_std_c99 = 1083,                        /* -std=c99 */
  /* OPT_std_c9x = 1084, */                  /* -std=c9x */
  OPT_std_f2003 = 1085,                      /* -std=f2003 */
  OPT_std_f2008 = 1086,                      /* -std=f2008 */
  OPT_std_f95 = 1087,                        /* -std=f95 */
  OPT_std_gnu = 1088,                        /* -std=gnu */
  OPT_std_gnu__0x = 1089,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1090,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1091,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1092, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1093,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1094,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1095, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1096, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1097,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1098, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1099, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1100,                     /* -std=legacy */
  OPT_symbolic = 1101,                       /* -symbolic */
  OPT_t = 1102,                              /* -t */
  OPT_time = 1103,                           /* -time */
  OPT_time_ = 1104,                          /* -time= */
  OPT_tno_android_cc = 1105,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1106,                 /* -tno-android-ld */
  OPT_traditional = 1107,                    /* -traditional */
  OPT_traditional_cpp = 1108,                /* -traditional-cpp */
  OPT_trigraphs = 1109,                      /* -trigraphs */
  OPT_u = 1110,                              /* -u */
  OPT_undef = 1111,                          /* -undef */
  OPT_v = 1112,                              /* -v */
  OPT_version = 1113,                        /* -version */
  OPT_w = 1114,                              /* -w */
  OPT_wrapper = 1115,                        /* -wrapper */
  OPT_x = 1116,                              /* -x */
  OPT_z = 1117,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
